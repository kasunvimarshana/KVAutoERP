...
use Modules\Taxation\Domain\Events\TaxRateDeactivated;
...
class DeactivateTaxRateService extends BaseService implements DeactivateTaxRateServiceInterface
{
    ...
    protected function handle(array $data): TaxRate
    {
        ...
        $this->addEvent(new TaxRateDeactivated($saved));
