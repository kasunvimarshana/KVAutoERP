...
namespace Modules\Employee\Infrastructure\Services;
...
class EloquentEmployeeUserSynchronizer implements EmployeeUserSynchronizerInterface
{
    ...
    public function resolveUserIdForCreate(
        ...
        if ($userPayload === null) {
            throw new DomainException('Either user_id or user payload is required to create an employee.');
        }
