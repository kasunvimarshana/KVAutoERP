...
class UpdateTenantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'api_keys' => 'sometimes|nullable|array',
            'settings' => 'sometimes|nullable|array',
            'plan' => 'sometimes|required|string|max:100',
            'tenant_plan_id' => 'sometimes|nullable|exists:tenant_plans,id',
            'status' => 'sometimes|required|in:active,suspended,pending,cancelled',
            'trial_ends_at' => 'sometimes|nullable|date_format:Y-m-d H:i:s',
            'subscription_ends_at' => 'sometimes|nullable|date_format:Y-m-d H:i:s',
