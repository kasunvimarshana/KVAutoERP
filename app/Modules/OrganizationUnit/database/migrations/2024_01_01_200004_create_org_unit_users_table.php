...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('org_unit_users', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tenant_id')->constrained('tenants', 'id', 'org_unit_users_tenant_id_fk')->cascadeOnDelete();
            $table->foreignId('org_unit_id')->constrained('org_units', 'id', 'org_unit_users_org_unit_id_fk')->cascadeOnDelete();
