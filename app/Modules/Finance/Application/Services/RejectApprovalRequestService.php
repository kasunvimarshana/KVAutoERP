...
class RejectApprovalRequestService extends BaseService implements RejectApprovalRequestServiceInterface
{
    ...
    protected function handle(array $data): ApprovalRequest
    {
        ...
        $approvalRequest->reject($resolvedByUserId, $comments);
