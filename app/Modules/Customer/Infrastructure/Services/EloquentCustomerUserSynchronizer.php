...
class EloquentCustomerUserSynchronizer implements CustomerUserSynchronizerInterface
{
    ...
    public function resolveUserIdForCreate(
        ...
        if ($userPayload === null) {
            throw new DomainException('Either user_id or user payload is required to create a customer.');
        }
