...
class ProductSearchProjectionModel extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'default_sales_unit_price',
        'default_sales_currency_id',
        'default_sales_price_uom_id',
        'default_purchase_unit_price',
        'default_purchase_currency_id',
        'default_purchase_price_uom_id',
        'searchable_text',
        'source_updated_at',
        'last_projected_at',
    ];
    ...
    protected $casts = [
        ...
        'default_sales_currency_id' => 'integer',
        'default_sales_price_uom_id' => 'integer',
        'default_purchase_currency_id' => 'integer',
        'default_purchase_price_uom_id' => 'integer',
        ...
        'default_sales_unit_price' => 'decimal:6',
        'default_purchase_unit_price' => 'decimal:6',
