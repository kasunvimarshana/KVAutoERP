...
class FindAttributeValueService implements FindAttributeValueServiceInterface
{
    private const ALLOWED_FILTERS = ['tenant_id', 'attribute_id', 'is_active'];
    ...
    public function find(mixed $id): ?AttributeValue
    {
    ...
    {
        $repository = $this->attributeValueRepository->resetCriteria();
