...
class FindProductBrandService implements FindProductBrandServiceInterface
{
    /** @var array<string> */
    ...
    public function find(mixed $id): ?ProductBrand
    {
        return $this->productBrandRepository->find($id);
    }

    public function list(array $filters = [], ?int $perPage = null, int $page = 1, ?string $sort = null, ?string $include = null): LengthAwarePaginator
    {
        $repository = $this->productBrandRepository->resetCriteria();
