...
class FindProductAttributeGroupService implements FindProductAttributeGroupServiceInterface
{
    /** @var array<string> */
    private const ALLOWED_FILTERS = ['tenant_id', 'name'];

    /** @var array<string> */
    private const ALLOWED_SORTS = ['id', 'name', 'created_at', 'updated_at'];

    public function __construct(private readonly ProductAttributeGroupRepositoryInterface $repository) {}

    public function find(mixed $id): ?ProductAttributeGroup
    {
