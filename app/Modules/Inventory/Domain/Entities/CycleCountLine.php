...
class CycleCountLine
{
    ...
    public function getSystemQty(): string { return $this->systemQty; }

    public function getCountedQty(): string { return $this->countedQty; }

    public function getVarianceQty(): string { return $this->varianceQty; }

    public function getUnitCost(): string { return $this->unitCost; }

    public function getVarianceValue(): string { return $this->varianceValue; }

    public function getAdjustmentMovementId(): ?int { return $this->adjustmentMovementId; }
}
