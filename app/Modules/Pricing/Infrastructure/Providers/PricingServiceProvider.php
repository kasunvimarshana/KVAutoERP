...
class PricingServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(PriceListRepositoryInterface::class, function ($app) {
            return new EloquentPriceListRepository($app->make(PriceListModel::class));
        });

        $this->app->bind(PriceListItemRepositoryInterface::class, function ($app) {
            return new EloquentPriceListItemRepository($app->make(PriceListItemModel::class));
        });

        $this->app->bind(DiscountRepositoryInterface::class, function ($app) {
            return new EloquentDiscountRepository($app->make(DiscountModel::class));
        });

        $this->app->bind(PriceListServiceInterface::class, function ($app) {
            return new PriceListService($app->make(PriceListRepositoryInterface::class));
        });

        $this->app->bind(ResolvePriceServiceInterface::class, function ($app) {
            return new ResolvePriceService($app->make(PriceListItemRepositoryInterface::class));
        });
