...
use Modules\Warehouse\Infrastructure\Persistence\Eloquent\Models\StockMovementModel;

class EloquentWarehouseStockMovementRepository implements WarehouseStockMovementRepositoryInterface
{
    ...
    {
        return $this->movementBelongsToWarehouse($tenantId, $warehouseId, $locationId);
    }
    ...
    public function paginateStockLevelsByWarehouse(int $tenantId, int $warehouseId, int $perPage, int $page): LengthAwarePaginator
    {
