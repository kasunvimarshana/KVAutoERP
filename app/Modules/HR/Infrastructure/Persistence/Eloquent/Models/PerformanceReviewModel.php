...
class PerformanceReviewModel extends BaseModel
{
    ...
    public function cycle(): BelongsTo { return $this->belongsTo(PerformanceCycleModel::class, 'cycle_id'); }
    public function reviewer(): BelongsTo { return $this->belongsTo(UserModel::class, 'reviewer_id'); }
}
