...
class PayslipModel extends BaseModel
{
    ...
    public function payrollRun(): BelongsTo { return $this->belongsTo(PayrollRunModel::class, 'payroll_run_id'); }
    public function lines(): HasMany { return $this->hasMany(PayslipLineModel::class, 'payslip_id'); }
}
