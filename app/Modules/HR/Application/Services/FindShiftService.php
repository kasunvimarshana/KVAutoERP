...
class FindShiftService implements FindShiftServiceInterface
{
    /** @var list<string> */
    private const ALLOWED_FILTERS = ['tenant_id', 'code', 'shift_type', 'is_active'];

    /** @var list<string> */
    private const ALLOWED_SORTS = ['id', 'name', 'code', 'shift_type', 'is_active', 'created_at'];

    public function __construct(
        private readonly ShiftRepositoryInterface $shiftRepository,
    ) {}

    public function find(mixed $id): ?Shift
    {
    ...
    public function list(
        ...
        $repository = $this->shiftRepository->resetCriteria();
