...
class FindLeaveBalanceService implements FindLeaveBalanceServiceInterface
{
    /** @var list<string> */
    private const ALLOWED_FILTERS = ['tenant_id', 'employee_id', 'leave_type_id', 'year'];

    /** @var list<string> */
    private const ALLOWED_SORTS = ['id', 'employee_id', 'leave_type_id', 'year', 'allocated', 'used', 'created_at'];

    public function __construct(
        private readonly LeaveBalanceRepositoryInterface $balanceRepository,
    ) {}

    public function find(mixed $id): ?LeaveBalance
    {
    ...
    public function list(
        ...
        $repository = $this->balanceRepository->resetCriteria();
