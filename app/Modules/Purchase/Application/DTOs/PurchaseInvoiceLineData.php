...
class PurchaseInvoiceLineData
{
    public function __construct(
        ...
        public readonly int $purchase_invoice_id,
        ...
        public readonly string $tax_amount = '0',
        public readonly ?int $grn_line_id = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            line_total: (string) $data['line_total'],
            discount_pct: isset($data['discount_pct']) ? (string) $data['discount_pct'] : '0',
            tax_amount: isset($data['tax_amount']) ? (string) $data['tax_amount'] : '0',
            grn_line_id: isset($data['grn_line_id']) ? (int) $data['grn_line_id'] : null,
