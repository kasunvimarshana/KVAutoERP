 ...
 *
 * This entity is intentionally read-heavy: once created it is immutable with
 * the exception of the optional metadata which can be enriched after the fact.
 */
class AuditLog
{
    ...
    /**
     * Determine whether this entry records a change (has both old and new values).
     */
    ...
    /**
     * Return the diff between old and new values.
     *
