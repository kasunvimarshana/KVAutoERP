...
abstract class BaseRepository
{
    ...
    /**
     * Apply pagination to a query builder, collection, or array.
     *
     * @param Builder|array<int, mixed>|Collection $source
     */
    public function applyPagination(mixed $source, \App\Application\Shared\DTOs\PaginationDTO $pagination): Collection|LengthAwarePaginator
    {
        if ($pagination->perPage === 0) {
            ...
            return is_array($source) ? collect($source) : $source;
        }
