...
abstract class BaseRepository
{
    ...
    /**
     * Return paginated results if per_page is provided, otherwise return all records.
     */
     ...
     *
     * Supported operators: eq, like, gt, lt, between, in
     *
     * $filters = [
     ...
     *   ['column' => 'score',  'operator' => 'between', 'value' => [10, 50]],
    ...
    /**
     * Return a scoped clone with the given relations eager-loaded.
     * Using clone ensures the singleton repository instance is never mutated,
     * preventing state leaking across requests.
     */
    ...
    /**
     * Return a scoped clone filtered to the given tenant.
     * Using clone ensures the singleton repository instance is never mutated,
     * preventing state leaking across requests.
     */
