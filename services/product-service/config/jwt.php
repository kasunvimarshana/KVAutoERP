...
/**
 * JWT configuration for the Product Service.
 *
...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Redis Revocation Key Prefixes
    |--------------------------------------------------------------------------
    | Prefixes for the Redis keys used by the distributed revocation list.
    |   - jti_prefix:     revoke:<jti_prefix><jti>
    |   - version_prefix: revoke:<version_prefix><user_id>
    */
    'revocation' => [
        'jti_prefix'     => env('JWT_REVOCATION_JTI_PREFIX', 'revoke:jti:'),
        'version_prefix' => env('JWT_REVOCATION_VERSION_PREFIX', 'revoke:user:'),
    ],
