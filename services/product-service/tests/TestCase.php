...
/**
 * Abstract base test case for the Product Service.
 *
...
abstract class TestCase extends BaseTestCase
{
    ...
    /** Fixed organization UUID (UUID v4) used in product creation tests. */
     ...
     *
     * Call this in setUp() of any test that exercises database queries.
     *
     ...
     *
     * @param  array<string, mixed>  $overrides  Any claim overrides.
