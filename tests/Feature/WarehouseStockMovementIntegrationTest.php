...
class WarehouseStockMovementIntegrationTest extends TestCase
{
    ...
    public function test_transfer_movement_updates_stock_levels_for_both_locations(): void
    {
        ...
        /** @var RecordWarehouseStockMovementServiceInterface $recordWarehouseStockMovementService */
        $recordWarehouseStockMovementService = app(RecordWarehouseStockMovementServiceInterface::class);
        ...
        $movement = $recordWarehouseStockMovementService->execute([
            'tenant_id' => $tenantId,
            'warehouse_id' => $warehouse->getId(),
            'product_id' => 1001,
