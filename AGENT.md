# Coding Agent Instructions for KVAutoERP

> These instructions define how AI coding agents should operate in this repository. For full coding conventions, see [`.github/copilot-instructions.md`](.github/copilot-instructions.md).
