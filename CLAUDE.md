# Claude Instructions for KVAutoERP

> These instructions apply when Claude is used as an AI coding assistant in this repository. They mirror the conventions in [`.github/copilot-instructions.md`](.github/copilot-instructions.md).
